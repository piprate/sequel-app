...
import { formatTimeagoDate, formatTimeagoFutureDate } from '../routes/_intl/formatTimeagoDate.js'

describe('test-timeago.js', () => {
  it.concurrent('test past date', async () => {
    const now = Date.now()
  ...
  it.concurrent('test future date', async () => {
    const now = Date.now()
