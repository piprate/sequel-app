...
export const timelineGroupHeads = deriveForCurrentTimeline(rootTimelineGroupHeads, null)
export const lastReaderModeTimelineItem = deriveForCurrentTimeline(rootLastReaderModeTimelineItem, null)
export const timelineItemSummaries = deriveForCurrentTimeline(rootTimelineItemSummaries, null)
export const timelineItemSummariesToAdd = deriveForCurrentTimeline(rootTimelineItemSummariesToAdd, null)
export const runningUpdate = deriveForCurrentTimeline(rootRunningUpdate, false)
export const lastFocusedElementId = deriveForCurrentTimeline(rootLastFocusedElementId, null)
export const ignoreBlurEvents = deriveForCurrentTimeline(rootIgnoreBlurEvents, false)
export const showHeader = deriveForCurrentTimeline(rootShowHeader, false)
export const shouldShowHeader = deriveForCurrentTimeline(rootShouldShowHeader, false)
export const timelineItemSummariesAreStale = deriveForCurrentTimeline(rootTimelineItemSummariesAreStale, false)
export const timelineNextPageId = deriveForCurrentTimeline(rootTimelineNextPageId, null)
export const freshUpdates = deriveForCurrentTimeline(rootFreshUpdates, null)
export const postFromSocket = deriveForCurrentTimeline(rootPostFromSocket, null)
...
export const currentTimelineType = derived(
  currentTimeline,
  ($currentTimeline) => $currentTimeline && $currentTimeline.split('/')[0]
)

export const currentTimelineValue = derived(currentTimeline, ($currentTimeline) => {
  if (!$currentTimeline) {
    return undefined
  }
...
export const firstTimelineItemId = derived(timelineItemSummaries, ($timelineItemSummaries) =>
  getFirstIdFromItemSummaries($timelineItemSummaries)
)

export const lastTimelineItemId = derived(timelineItemSummaries, ($timelineItemSummaries) =>
