...
export const unexpiredInstanceFilterRegexes = derived(unexpiredInstanceFilters, ($unexpiredInstanceFilters) => {
  return Object.fromEntries(
    Object.entries($unexpiredInstanceFilters).map(([instanceName, filters]) => {
      const contextsToRegex = Object.fromEntries(
        WORD_FILTER_CONTEXTS.map((context) => {
