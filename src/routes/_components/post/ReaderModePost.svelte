  ...
  import { formatIntl } from '../../_utils/formatIntl';
    ...
    $: ariaLabel = (
            getAccessibleLabelForPost(postAuthor, plainTextBody,
                    ...
                    undefined, visibility, $omitEmojiInDisplayNames, $disableLongAriaLabels,
                    showMedia
            )
    )
    $: className = classname(
    ...
    $: authorWroteInBubble = formatIntl('intl.authorWroteInBubble', { author: post.authorRef.name, bubble: post.bubbleRef.name })
