<script>
  ...
  import { largeInlineMedia, markMediaAsSensitive, neverMarkMediaAsSensitive, sensitivesShown } from '../../_store/local'
  ...
  $: mediaAttachments = originalStatus.media_attachments;
