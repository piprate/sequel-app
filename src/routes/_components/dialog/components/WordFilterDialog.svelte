<script>
  ...
  function computeConfirmationButtonDisabled() {
    confirmationButtonDisabled = !(wordInput.value.replace(/\s+/g, '') &&
...
<GenericConfirmationDialog
  ...
  <div class="word-filter-dialog">
    ...
    <div class="word-filter-where-to-filter">
      ...
      <ul class="word-filter-radio-list" aria-describedby="word-filter-where-to-filter-label" bind:this={contextCheckboxes}>
    ...
    <div class="word-filter-irreversible">
      <input type="checkbox"
             name="irreversible"
             bind:this={irreversibleCheckbox}
