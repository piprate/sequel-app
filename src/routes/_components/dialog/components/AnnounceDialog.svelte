...
<GenericConfirmationDialog {id} {parentDialogId} {label} {title} isConfirming={loading} negativeText={intl.no} positiveText={intl.yes} confirmationButtonDisabled={loading} on:positive={announce} on:negative={closeDialog}>
  <div class="body">
