  ...
  <FreeTextLayout>
    <div class="not-logged-in-box">
      ...
      <div class={panelClass}>
        <a class="button primary action-button" data-sveltekit-preload-data href="/settings/instances/register"
          >{intl.signUp}</a
        >
        <a class="button primary action-button" data-sveltekit-preload-data href="/settings/instances/add"
          >{intl.logIn}</a
        >
        {#if offerVisitorMode}
          <span class="visitor-invite"
