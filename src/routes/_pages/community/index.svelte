<script>
  ...
  $: subRequestsLabel = formatIntl('intl.subRequestsLabel', {
  ...
  onMount(async () => {
    ...
    if ($isAuthenticated) {
      await Promise.all([updateListsForInstance($currentInstance), updateSubRequestCountIfLockedUser($currentInstance)])
    }
  })
</script>
...
{#if $isUserLoggedIn}
  <div class="community-page">
    <FocusRestoration realm="community">
      <RadioGroup id="pinnables" length={numPinnable} label={intl.pinnableTimelines}>
