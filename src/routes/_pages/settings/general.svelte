...
<SettingsLayout page="settings/general" label={intl.general}>
  ...
  <form bind:this={mediaForm} name="media" class="ui-settings" on:change={onChange}>
    <label class="setting-group">
      <input
        ...
        type="checkbox"
        id="choice-never-mark-media-sensitive"
    ...
    <label class="setting-group">
      <input
        name="allMediaSensitive"
        type="checkbox"
        id="choice-mark-media-sensitive"
  ...
  <form bind:this={uiForm} name="ui" class="ui-settings" on:change={onChange}>
    <label class="setting-group">
      <input
        name="disableCustomScrollbars"
        type="checkbox"
        id="choice-disable-custom-scrollbars"
        checked={$disableCustomScrollbars}
      />
    ...
    <label class="setting-group">
      <input
        ...
        type="checkbox"
        id="choice-disable-infinite-scroll"
        checked={$disableInfiniteScroll}
      />
      {intl.disableInfiniteScrollPre}
      <Tooltip text={intl.disableInfiniteScrollText} tooltipText={intl.disableInfiniteScrollDescription} />
  ...
  <form bind:this={a11yForm} name="a11y" class="ui-settings" on:change={onChange}>
    ...
    <label class="setting-group">
      <input
        name="alwaysShowFocusRing"
        type="checkbox"
        id="choice-always-show-focus-ring"
        checked={$alwaysShowFocusRing}
      />
      {intl.showRingPre}
      <Tooltip text={intl.showRingText} tooltipText={intl.showRingDescription} />
      {intl.showRingPost}
    </label>
    <label class="setting-group">
    ...
    <label class="setting-group">
      <input
        name="omitEmojiInDisplayNames"
        type="checkbox"
        id="choice-omit-emoji-in-display-names"
        checked={$omitEmojiInDisplayNames}
      />
      {intl.removeEmoji}
    </label>
    <label class="setting-group">
      <input
        name="disableLongAriaLabels"
        type="checkbox"
        id="choice-disable-long-aria-labels"
        checked={$disableLongAriaLabels}
      />
      {intl.shortAria}
    </label>
  </form>
