...
<SettingsLayout page="settings/hotkeys" label={intl.hotkeys}>
  ...
  <form
    name="hotkeys"
    class="ui-settings"
    aria-label={intl.hotkeySettings}
    bind:this={hotkeysForm}
  ...
  >
    <label class="setting-group {allowChangeHotkeySetting ? '' : 'disabled-style'}">
      <input
        name="disableAll"
        type="checkbox"
        id="choice-disable-hotkeys"
        bind:checked={disableAll}
    ...
    <label class="setting-group {allowChangeLeftRightSetting ? '' : 'disabled-style'}">
      <input
        name="leftRightChangesFocus"
        type="checkbox"
        id="choice-left-right-focus"
        checked={$leftRightChangesFocus}
