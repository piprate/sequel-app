<script>
  import DigitalArtEdit from '../../../../_components/digitalart/DigitalArtEdit.svelte';
  ...
  <DynamicPageBanner title="{intl.editDigitalArt}" />
  {#if $currentSpark}
      <DigitalArtEdit realm="edit_digital_art" digitalArtId={params.id} />
  {:else}
      <InfoAside>
