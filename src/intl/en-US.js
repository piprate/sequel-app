...
const intl = {
  ...
  emailColon: 'Email:',
  newPasswordColon: 'Enter new password:',
  ...
  enterRecoveryPhrase: 'Enter recovery phrase that you received at account registration',
  continue: 'Continue',
  ...
  labelMentionedYou: '{name} mentioned you',
  ...
  listingHistory: 'Sold',
  releaseEmpty: 'No active listings in this release.',
  newRelease: 'New Release',
  editRelease: 'Edit Release',
  releaseNameColon: 'Name',
  releaseSummaryColon: 'Summary (optional)',
  releaseStatus: 'Status',
  releaseDraftColon: 'Draft',
  releaseActiveColon: 'Active',
  releaseStartsAtColon: 'Starts At (optional)',
  ...
  releasePage: 'Marketplace Release named {release}',
